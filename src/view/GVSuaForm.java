...
public class GVSuaForm extends javax.swing.JDialog {

    public GVSuaForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        int result = JOptionPane.showConfirmDialog(null,
                "Bạn muốn sửa đề tài?","Thông báo",JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GVSuaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GVSuaForm dialog = new GVSuaForm(new javax.swing.JFrame(), true);
